...
export const LOAD_USER_POST_REQUEST="";
export const LOAD_USER_POST_SUCCESS="";
export const LOAD_USER_POST_FAIL="";

// 유저가 좋아요한 포스트 로딩

export const LOAD_LIKED_POST_REQUEST="";
export const LOAD_LIKED_POST_SUCCESS="";
export const LOAD_LIKED_POST_FAIL="";


export const loadOtherUserInfoAction=(data)=>{
    return {
